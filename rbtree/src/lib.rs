...
impl RBTree {
    ...
    pub fn is_a_valid_red_blacK_tree(&self) -> bool {
        ...
        let blac_height_min = result.1;
        let black_height_max = result.2;
        red_red == 0 && black_height_max == blac_height_min
    }
        ...
        match direction {
            Rotation::Right => {
                ...
                if y.is_some() {
                    ...
                    if y.as_ref().unwrap().borrow_mut().right.is_some() {
